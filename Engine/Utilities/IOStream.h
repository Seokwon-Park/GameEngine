...
namespace primal::utl
{
	...
	public:
		...
		// THis tmemplate function is intended to read primitive types( e.g. int, float ,bool)
		template<typename T>
		[[nodiscard]] T read()
		{
			T value{ *((T*)_position) };
	...
	public:
		...
		// THis tmemplate function is intended to write primitive types( e.g. int, float ,bool)
		template<typename T>
		void write(T value )
		{
