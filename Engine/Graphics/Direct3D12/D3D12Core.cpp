...
{
	//TODO: root signature 만들줄 알고나면 지울것.
	...
	void create_a_root_signature()
	{
		...
		{
			// param2 : descriptor table (unbounded/bindless)
			auto& param = params[2];
		...
		// only one resource heap and one sampler heap can be set any time
		// so, max number of heap is 2.
		...
		// record the reset of rendering commands...
#endif
	...
	void create_a_root_signature2()
	{
		d3dx::d3d12_descriptor_range range{ D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 0,D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND };
