...
namespace
{
	...
	constexpr math::v3 rgb_to_color(u8 r, u8 g, u8 b)
	{
...
void test_lights(f32 dt)
{
	...
	for (u32 i{ 0 }; i < count; ++i)
	{
		math::v3 p1{ (random() * 2 - 1.f) * 13.f * scale.x, (random() * 2 - 1.f) * 13.f * scale.y, (random() * 2 - 1.f) * 13.f * scale.z };
		math::v3 p2{ (random() * 2 - 1.f) * 13.f * scale.x, (random() * 2 - 1.f) * 13.f * scale.y, (random() * 2 - 1.f) * 13.f * scale.z };
